...
| enclustra_env_on_sd.appendix                | Settings to store environment on SD card                |
...
| Xilinx Zynq-7000 SoC |                       |
|----------------------|-----------------------|
| Mars ZX2             | zynq-mars-zx2.dts     |
| Mars ZX3             | zynq-mars-zx3.dts     |
| Mercury ZX1          | zynq-mercury.dts      |
| Mercury ZX5          | zynq-mercury.dts      |
| Cosmos XZQ10         | zynq-cosmos-xzq10.dts |

| Xilinx Zynq Ultrascale+ MPSoC |                 |
|-------------------------------|-----------------|
| Mars XU3                      | mars-xu3.dts    |
| Mercury+ XU1                  | mercury-xu1.dts |
| Mercury XU5                   | mercury-xu5.dts |
| Mercury+ XU7                  | mercury-xu7.dts |
| Mercury+ XU8                  | mercury-xu8.dts |
